...
<form autocomplete="off">
  ...
  <table border="1">
    <tbody>
      ...
      <tr><td title="如選擇夫婦合併評稅請在在此另行加上132,000">適用於{{taxYear1}}年度的其他免稅額<img src="../icon/info.png" class="icon"></td><taxpayerforminputtextfield v-for="(taxpayer,index) in taxpayers" :index=index :key=index :taxpayer="taxpayer" field="otherAllowancesThisYear" /></tr>
      <tr><td title="如選擇夫婦合併評稅請在在此另行加上132,000">適用於{{taxYear2}}年度的其他免稅額<img src="../icon/info.png" class="icon"></td><taxpayerforminputtextfield v-for="(taxpayer,index) in taxpayers" :index=index :key=index :taxpayer="taxpayer" field="otherAllowancesNextYear" /></tr>
